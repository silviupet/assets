...
@section('meta_descriere')
    Aici gasim toate atributele , tag-urile, documentele {{$asset->name}}
@endsection
@section('title')
    Assets
@endsection
...
<div class="collapse" id="collapseExample1">
    <div class="card card-body">
        ...
        @foreach($asset->atributes as $key_atribute =>$atribute)
            <div>
                <hr style="border-color: #1c294e">
            </div>
           <div>
...
{{--                                   {!! Form::close() !!}--}}
               ...
               <!-- Button trigger modal -->
               <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#addDoc{{$key_atribute}}">
                   Add a document
               </button>
               <!-- Modal for add a document -->
               <div class="modal fade" id="addDoc{{$key_atribute}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                   <div class="modal-dialog" role="document">
                       <div class="modal-content">
                           <div class="modal-header">
...
<!-- Colapse tags-->
    <div class="collapse" id="collapseExample2">
        <div class="card card-body">
{{--             <h5>Tags of asset {{$asset->name}}</h5>--}}
                 @if(count($tags)>0)
...
{{--                               <button type="button" class="btn btn-outline-primary">{{$tag->name}}</button>--}}
                     ...
                     @endforeach
                                 ...
                                 <button type="button" class="btn btn-primary"  data-toggle="collapse" data-target="#collapseExample3{{$key}}" aria-expanded="false" aria-controls="collapseExample" >Add a tag</button>
                                <button type="button" class="btn btn-danger"  data-toggle="collapse" data-target="#collapseExample4{{$key}}" aria-expanded="false" aria-controls="collapseExample">Delete a tag</button>
                            </p>
                         <!--colapse add a tag-->
