...
{{--                <i class="fas fa-fw fa-cog"></i>--}}
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Custom Assets:</h6>
                    <a class="collapse-item" href={{route('assets.index')}}>Team Assets</a>
                    <a class="collapse-item" href={{route('assets.create')}}>Create a New Asset</a>
                </div>
            </div>
        </li>
...
{{--                <i class="fas fa-fw fa-chart-area"></i>--}}
                <span>Categories List/Create</span></a>
        </li>
